...
type CategoryServiceClient interface {
	...
	ListCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CatregoryList, error)
...
type CategoryService_CreateCategoryStreamClient interface {
	...
	CloseAndRecv() (*CatregoryList, error)
	grpc.ClientStream
}
...
func (x *categoryServiceCreateCategoryStreamClient) CloseAndRecv() (*CatregoryList, error) {
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CatregoryList, error) {
	out := new(CatregoryList)
...
type CategoryServiceServer interface {
	...
	ListCategories(context.Context, *Blank) (*CatregoryList, error)
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *Blank) (*CatregoryList, error) {
...
type CategoryService_CreateCategoryStreamServer interface {
	SendAndClose(*CatregoryList) error
...
func (x *categoryServiceCreateCategoryStreamServer) SendAndClose(m *CatregoryList) error {
